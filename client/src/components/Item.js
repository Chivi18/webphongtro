...
const Item = ({
  ...
  return (
    <div className="w-full flex border-t border-orange-600 py-4">
      <Link to={`chi-tiet/${fomatVietnamesetoString(title)}/${id}`} className="w-2/5 flex flex-wrap gap-[2px] items-center relative cursor-pointer">
        {image.length > 0 &&
          image
      ...
      <div className="w-3/5">
        ...
        <p className="text-gray-500 w-full h-[50px]  text-allipsis overflow-hidden">
          {description}
        </p>
